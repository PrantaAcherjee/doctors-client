  ...
  return (
    <div>
      ...
      <Grid style={{display:'flex',justifyContent:"center",alignItems:'center'}} container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
        <Grid xs={12} md={6}>
        <img style={{height:'90%',width:'90%'}} src={treatment} />  
        </Grid>
        <Grid xs={12} md={6}>
        <Typography variant='h3' style={{margin:'4rem 0'}}>
          Exceptional Dental Care,<br/> On Your Terms
        </Typography>
        <p style={{letterSpacing:'0.5px',textAlign:'justify',paddingLeft:'2rem',color:'gray',lineHeight:'30px'}}>
        ...
        <br/>
        <Button style={{background:'cyan',marginTop:'5rem'}} variant='contained'>Learn More</Button>
        </Grid>        
      </Grid>
     </Box>
     </Container>
